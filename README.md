...
dune_spack contains build recipes for DUNE's offline software.  Further information can be found in the [wiki](https://github.com/DUNE/dunesw/wiki) for the LArSoft-based stack.
